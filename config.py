...
class Config(object):
    ...
    TECH_VJ_API_HASH = os.environ.get("TECH_VJ_API_HASH", "aa7c2b3be68a7488abdb9de6ce78d311")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("TECH_VJ_OWNER_ID", "5380833276")) 
    ...
    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("TECH_VJ_LOG_CHANNEL", "1002106332206")) # your log channel id and make bot admin in log channel with full right 
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = environ.get('TECH_VJ_UPDATES_CHANNEL', '-1002106332206') # your update channel id and make bot admin in update channel with full right
